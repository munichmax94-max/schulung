...
def main():
    ...
    tests = [
        ...
        ("Presentation Modules Exist", tester.test_presentation_modules_exist),
        ("Presentation Structure", tester.test_presentation_structure),
        ("Sample Course Has 3 Modules", tester.test_sample_course_has_three_modules),
        ("Presentation Slides Content", tester.test_presentation_slides_content),
